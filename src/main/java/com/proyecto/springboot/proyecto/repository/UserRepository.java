...
import com.proyecto.springboot.proyecto.dto.UserDto;
...
public interface UserRepository extends PagingAndSortingRepository<User, Long> {
        ...
        // @Query("select new package com.proyecto.springboot.proyecto.dto.UserDto(u.id,
        // u.name u.birthDate)"
        // + "FROM User u" + "where u.birthDate=: parametroFecha" + "and
        // u.email=:parametroEmail")
        // Optional<UserDto> getAllByBirthDateAndEmail(@Param("parametroFecha")
        // LocalDate date,
